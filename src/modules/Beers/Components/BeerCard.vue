  ...
  <div class="flex flex-col max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
    ...
    <div class="p-5 flex flex-col flex-grow">
      ...
      <div class="mt-auto flex" >
        <RouterLink :to="link" class="inline-flex items-center justify-center w-full px-3 py-2 text-sm font-medium text-hopix-gray bg-hopix-yellow rounded-lg hover:underline focus:ring-4 focus:outline-none focus:ring-hopix-yellow dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" style="flex: 1">
          Read more
